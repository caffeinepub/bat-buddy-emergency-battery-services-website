    ...
    <header className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-md border-b border-primary/20 dark:border-gray-700 sticky top-0 z-50">
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          ...
          >
            <img src="/assets/IMG-20260128-WA0008.jpg" alt="BAT-BUDDY Logo" className="h-12 w-auto" />
            <div className="flex flex-col items-start">
              <span className="text-xl md:text-2xl font-bold text-primary">BAT‑BUDDY</span>
              <span className="text-xs md:text-sm text-gray-600 dark:text-gray-400">Power When You Need It.</span>
            </div>
          </button>
