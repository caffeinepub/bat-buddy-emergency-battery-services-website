    ...
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-amber-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="max-w-3xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          {/* Eleventh Battery Card - AGM 80 (Bosch S5 A06) */}
          <Card
            data-ocid="battery_price.card.11"
            className="shadow-xl border-2 border-amber-200 dark:border-amber-700 overflow-hidden"
          >
            <CardContent className="p-0">
              {/* Battery Image */}
              <div className="relative bg-white dark:bg-gray-800">
                <img
                  src="/assets/uploads/IMG-20260304-WA0014-1.jpg"
                  alt="Bosch S5 A06 12V DIN80 80AH AGM Car Battery - AGM 80"
                  className="w-full object-cover"
                />
              </div>
              ...
              <div className="p-6 bg-white dark:bg-gray-900">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">
                  Bosch S5 A06 12V DIN80 80AH AGM
                </p>
                ...
                <Button
                  data-ocid="battery_price.primary_button.11"
                  className="w-full bg-amber-600 hover:bg-amber-700 text-white font-bold py-3 text-lg flex items-center justify-center gap-2"
                  onClick={() => navigate({ to: "/battery-prices" })}
                >
                  <ShoppingCart className="h-5 w-5" />
          ...
          {/* Twelfth Battery Card - AGM 70 (Bosch S5 A04) */}
          <Card
            data-ocid="battery_price.card.12"
            className="shadow-xl border-2 border-amber-200 dark:border-amber-700 overflow-hidden"
          >
            <CardContent className="p-0">
              {/* Battery Image */}
              <div className="relative bg-white dark:bg-gray-800">
                <img
                  src="/assets/uploads/IMG-20260304-WA0011-1.jpg"
                  alt="Bosch S5 A04 12V DIN70 70AH AGM Car Battery - AGM 70"
                  className="w-full object-cover"
                />
              </div>
              ...
              <div className="p-6 bg-white dark:bg-gray-900">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">
                  Bosch S5 A04 12V DIN70 70AH AGM
                </p>
                ...
                <Button
                  data-ocid="battery_price.primary_button.12"
                  className="w-full bg-amber-600 hover:bg-amber-700 text-white font-bold py-3 text-lg flex items-center justify-center gap-2"
                  onClick={() => navigate({ to: "/battery-prices" })}
                >
                  <ShoppingCart className="h-5 w-5" />
