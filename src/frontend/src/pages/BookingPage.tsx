...
export default function BookingPage() {
  ...
  const [_locationPermissionDenied, setLocationPermissionDenied] =
    useState(false);
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-xl text-muted-foreground">
              Fast, reliable battery service at your location
            </p>
          </div>
            ...
            <TabsContent value="booking">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Fill in your details and we'll dispatch a technician to your
                    location
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <form onSubmit={handleBookingSubmit} className="space-y-6">
                    ...
                    <div className="space-y-4">
                      ...
                      {latitude && longitude && (
                        <Alert>
                          ...
                          <AlertDescription>
                            Location detected: {latitude.toFixed(6)},{" "}
                            {longitude.toFixed(6)}
                          </AlertDescription>
                        </Alert>
                      )}
                    ...
                    <div>
                      ...
                      >
                        ...
                        <SelectContent>
                          <SelectItem value={ServiceType.batteryReplacement}>
                            Battery Replacement
                          </SelectItem>
                          <SelectItem value={ServiceType.jumpStart}>
                            Jump Start Service
                          </SelectItem>
                          <SelectItem value={ServiceType.roadsideAssistance}>
                            Roadside Assistance
                          </SelectItem>
                          <SelectItem value={ServiceType.fleetManagement}>
                            Fleet Management
                          </SelectItem>
                        </SelectContent>
                      </Select>
                            ...
                            <SelectContent>
                              {compatibleBatteries.map((battery) => (
                                <SelectItem key={battery.id} value={battery.id}>
                                  ...
                                  {Number(battery.capacity)}Ah - AED{" "}
                                  {Number(battery.price)}
                                </SelectItem>
                              ))}
                            </SelectContent>
                          </Select>
                    ...
                    {hasSearched &&
                      ...
                      (compatibleBatteries.length > 0 ? (
                                    ...
                                    <div className="text-right sm:text-left w-full sm:w-auto">
                                      ...
                                      <Button
                                        ...
                                        onClick={() => {
                                          ...
                                          toast.success(
                                            "Battery selected! Complete the booking form.",
                                          );
                                        }}
                                      >
                                        Select & Book
                        ...
                        <Alert>
                          <AlertCircle className="h-4 w-4" />
                          <AlertDescription>
                            No batteries found for {carMake} {carModel}{" "}
                            {carYear}. Please try different search criteria or
