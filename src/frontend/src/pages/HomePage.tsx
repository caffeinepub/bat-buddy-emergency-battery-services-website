    ...
    <div className="min-h-screen">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 py-16 md:py-20 relative">
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
            <div>
              <Badge className="mb-4 bg-primary hover:bg-primary/90 text-primary-foreground">24/7 Emergency Service</Badge>
              ...
              <p className="text-lg md:text-xl text-muted-foreground mb-6 md:mb-8">
                24/7 Emergency Service | Genuine Batteries | Up to 24 Months Warranty
              </p>
              <div className="flex flex-wrap gap-3 md:gap-4">
                ...
                <Button size="lg" variant="outline" className="bg-green-50 hover:bg-green-100 border-green-500" asChild>
                  <a href="https://wa.me/971559952721" target="_blank" rel="noopener noreferrer">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
            {trustPoints.map((point, index) => (
              <div key={index} className="flex items-center gap-2 md:gap-3 justify-center">
                ...
                <span className="font-medium text-xs md:text-base">{point.text}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="container mx-auto px-4 py-16 md:py-20">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4">
            Professional Service, <span className="text-primary">Anywhere You Are</span>
          </h2>
          <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto">
            Our fully-equipped service vans bring the workshop to you, ensuring fast and reliable battery replacement on-site.
          </p>
        </div>
      ...
      <section className="bg-gradient-to-r from-primary to-secondary py-16 md:py-20">
        <div className="container mx-auto px-4 text-center text-primary-foreground">
          <h2 className="text-2xl md:text-4xl lg:text-5xl font-bold mb-4 md:mb-6">Need Emergency Battery Service?</h2>
          <p className="text-lg md:text-xl mb-6 md:mb-8 opacity-90">We're available 24/7 to help you get back on the road</p>
